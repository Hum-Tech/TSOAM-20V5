-- ============================================================================
-- TSOAM CHURCH MANAGEMENT SYSTEM - COMPLETE DATABASE SETUP FOR SUPABASE
-- ============================================================================
-- Copy ALL content below and paste into Supabase SQL Editor
-- URL: https://app.supabase.com/project/teozbfjxarbpltfrguxe/sql/new
...
VALUES
  ('DIS-NAIROBI-CENTRAL', 'Nairobi Central', 'Central Nairobi district', TRUE),
  ('DIS-EASTLANDS', 'Eastlands', 'Eastlands district', TRUE),
  ('DIS-THIKA-ROAD', 'Thika Road', 'Thika Road district', TRUE),
  ('DIS-SOUTH-NAIROBI', 'South Nairobi', 'South Nairobi district', TRUE),
  ('DIS-WEST-NAIROBI', 'West Nairobi', 'West Nairobi district', TRUE),
  ('DIS-NORTH-NAIROBI', 'Northern Nairobi', 'Northern Nairobi district', TRUE),
  ('DIS-EAST-NAIROBI', 'Eastern Nairobi', 'Eastern Nairobi district', TRUE),
  ('DIS-SOUTH-EAST-NAIROBI', 'South East Nairobi', 'South East Nairobi district', TRUE),
  ('DIS-OUTSKIRTS-NAIROBI', 'Outskirts Nairobi', 'Outskirts Nairobi district', TRUE)
...
('member_management', 'Member Management', 'Complete member registration and tracking', '1.0.0', 29.99, 3500, 'monthly', '["Member Registration", "Member Tracking", "Communication", "Reports", "Bulk SMS"]', true),
('finance', 'Finance & Accounting', 'Tithe and offering management', '1.0.0', 49.99, 5800, 'monthly', '["Tithe Tracking", "Offering Management", "Expense Tracking", "Financial Reports", "Budget Planning", "Audit Trail"]', true),
('hr', 'HR & Payroll', 'Employee management and payroll', '1.0.0', 39.99, 4600, 'monthly', '["Employee Management", "Attendance Tracking", "Payroll Processing", "Leave Management", "Performance Reviews"]', true),
('homecells', 'HomeCells Management', 'Districts, zones, and home cells organization', '1.0.0', 24.99, 2900, 'monthly', '["District Management", "Zone Management", "HomCell Organization", "Leader Assignment", "Reporting"]', true),
('welfare', 'Welfare & Support', 'Member assistance and welfare programs', '1.0.0', 19.99, 2300, 'monthly', '["Assistance Tracking", "Support Requests", "Welfare Programs", "Beneficiary Management"]', true),
('events', 'Events Management', 'Church events and services', '1.0.0', 19.99, 2300, 'monthly', '["Event Planning", "Attendance Tracking", "Budget Tracking", "Event Reports"]', true),
('inventory', 'Inventory Management', 'Church assets and supplies', '1.0.0', 19.99, 2300, 'monthly', '["Asset Tracking", "Equipment Management", "Supply Management", "Maintenance Tracking"]', true),
('appointments', 'Appointments & Scheduling', 'Pastoral appointments', '1.0.0', 14.99, 1700, 'monthly', '["Appointment Scheduling", "Calendar Integration", "Reminder Notifications", "Counseling Logs"]', true)
ON CONFLICT (module_code) DO NOTHING;

-- ============================================================================
-- SETUP COMPLETE!
-- ============================================================================
-- All tables and data have been created.
