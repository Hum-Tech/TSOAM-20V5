  ...
  static async findAll(filters = {}) {
    try {
      ...
      if (!result.success) {
        ...
        const demoMembers = [
          {
            ...
            baptism_date: "2020-02-15",
            confirmation_date: "2020-03-15",
            department: "Adults Ministry",
            position: "Member",
            is_active: true,
          ...
          },
          {
            ...
            baptism_date: "2021-06-10",
            confirmation_date: "2021-07-10",
        ...
        return { success: true, data: demoMembers, demo: true };
      }
