...
router.post("/", async (req, res) => {
  try {
    ...
    const result = await query(
      `INSERT INTO messages (id, message_id, sender_id, recipient_ids, message_content, message_type, subject, recipient_type, status, parent_message_id, is_reply, created_at)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, 'sent', ?, ?, NOW())`,
      [
        messageId,
        messageUniqueId,
