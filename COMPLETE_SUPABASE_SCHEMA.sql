...
-- Version: 4.0 - COMPREHENSIVE WITH ALL FEATURES
-- ============================================================================
-- This script creates ALL tables required by every feature in the system
-- Modules: Auth, Members, Finance, HR, Events, Appointments, HomeCells,
--          Inventory, Welfare, Messaging, Documents, System Logs, Modules
...
-- User Requests (Account creation workflow)
...
-- New Members (Visitors & Registration)
...
CREATE INDEX IF NOT EXISTS idx_new_members_follow_up ON new_members(follow_up_needed);
...
CREATE INDEX IF NOT EXISTS idx_member_family_relationships_family ON member_family_relationships(family_id);

-- ============================================================================
-- 3. HOMECELLS & DISTRICT MANAGEMENT
-- ============================================================================
...
CREATE INDEX IF NOT EXISTS idx_homecell_members_homecell ON homecell_members(homecell_id);
CREATE INDEX IF NOT EXISTS idx_homecell_members_member ON homecell_members(member_id);
...
CREATE INDEX IF NOT EXISTS idx_homecell_assignments_homecell ON homecell_assignments(homecell_id);
...
CREATE TABLE IF NOT EXISTS leave_types (
  ...
  gender_restrictions VARCHAR(50) DEFAULT 'none',
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
...
-- Church Events (alternative table)
...
CREATE INDEX IF NOT EXISTS idx_document_uploads_uploader ON document_uploads(uploaded_by);
...
-- Subscriptions / Church Subscriptions
...
-- Alternative name for subscriptions
CREATE VIEW church_subscriptions AS SELECT * FROM subscriptions;

-- ============================================================================
-- 13. SAMPLE DATA INITIALIZATION
-- ============================================================================

-- Insert default admin user (will be replaced by script)
...
-- Already created above alongside tables
